...
export default function VisitorHome() {
  ...
  const areas = [
    { id: 'linguagens', label: 'Linguagens', icon: BookOpen, color: 'from-blue-500/20 to-blue-600/20', textColor: 'text-blue-400' },
    { id: 'humanas', label: 'Humanas', icon: Users, color: 'from-orange-500/20 to-orange-600/20', textColor: 'text-orange-400' },
    { id: 'natureza', label: 'Natureza', icon: Zap, color: 'from-green-500/20 to-green-600/20', textColor: 'text-green-400' },
    { id: 'matematica', label: 'Matemática', icon: Calculator, color: 'from-pink-500/20 to-pink-600/20', textColor: 'text-pink-400' },
  ];
          ...
          <div className="relative order-1 lg:order-2 w-full max-w-[320px] lg:max-w-none mx-auto animate-in fade-in slide-in-from-bottom-8 lg:slide-in-from-right-8 duration-1000">
            ...
            <div className="absolute -top-4 -right-4 lg:top-0 lg:right-0 animate-bounce-slow delay-100 z-20 scale-75 lg:scale-100 origin-top-right">
              <div className="bg-surface-dark/90 backdrop-blur-md border border-white/10 p-3 lg:p-4 rounded-2xl shadow-2xl flex items-center gap-3">
                ...
                <div>
                  <p className="text-[10px] font-bold text-text-dim uppercase tracking-wider">Conquista</p>
