...
import { Play, Star, AlertCircle, Share2, Heart, MessageSquare } from 'lucide-react';
...
export default function QuizDetails() {
  ...
  if (!quiz) return <div className="p-20 text-center text-error">Quiz not found</div>;
          ...
          <Card>
            <CardContent className="p-6">
              <h3 className="font-bold text-lg mb-4 flex items-center gap-2">
                <MessageSquare className="text-primary-light" /> Comments (0)
              </h3>
        ...
        <div className="space-y-6">
          <Card>
            <CardContent className="p-6 space-y-6">
              <div>
                <p className="text-sm text-text-dim mb-1">Created by</p>
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="bg-surface-darker p-4 rounded-xl border border-white/5">
                  ...
                  <div className="text-xs text-text-dim">Plays</div>
                </div>
