...
export const quizService = {
  ...
  generateAIQuiz: async (topic: string, difficulty: string, questionsCount: number): Promise<Quiz> => {
    if (USE_MOCKS) {
      ...
      return {
        id: 'ai-' + Math.random().toString(36).slice(2, 11),
          ...
          sections: [
            {
              ...
              name: "Álgebra",
              units: [
                { id: "1", name: "Equações Lineares", description: "O básico das equações", progress: 100, type: "theory", status: "completed" },
                { id: "2", name: "Equações Quadráticas", description: "Fórmula de Bhaskara", progress: 40, type: "quiz", status: "in-progress" },
              ]
            }
          ]
        },
