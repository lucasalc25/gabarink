...
const stains: Stain[] = [
  ...
  { t: '5%', l: '2%', s: '40px', c: 'fill-primary', r: '15deg', op: 0.6 },
  { t: '12%', l: '8%', s: '25px', c: 'fill-violet-400', r: '-10deg', op: 0.4 },
  { t: '8%', l: '15%', s: '60px', c: 'fill-[hsl(var(--primary-deep))]', r: '45deg', op: 0.5 },

  // Cluster Superior Direito
  { t: '5%', ri: '5%', s: '120px', c: 'fill-primary', r: '-20deg', op: 0.4 },
  ...
  { b: '10%', l: '5%', s: '80px', c: 'fill-primary', r: '15deg', op: 0.6 },
  { b: '5%', l: '15%', s: '30px', c: 'fill-violet-400', r: '200deg', op: 0.5 },

  // Cluster Inferior Direito
  { b: '15%', ri: '5%', s: '100px', c: 'fill-primary', r: '60deg', op: 0.5 },
  { b: '5%', ri: '15%', s: '45px', c: 'fill-violet-600', r: '15deg', op: 0.7 },

  // Espalhadas (Random)
  { t: '40%', l: '1%', s: '50px', c: 'fill-[hsl(var(--primary-deep))]', r: '180deg', op: 0.5 },
  { t: '45%', ri: '3%', s: '40px', c: 'fill-indigo-600', r: '75deg', op: 0.4 },
  { b: '40%', ri: '45%', s: '18px', c: 'fill-[hsl(var(--primary-deep))]', r: '110deg', op: 0.3 },
  { t: '30%', l: '35%', s: '20px', c: 'fill-primary', r: '0deg', op: 0.2 },
  { t: '70%', ri: '35%', s: '25px', c: 'fill-violet-500', r: '80deg', op: 0.2 },
  { t: '60%', ri: '25%', s: '300px', c: 'fill-primary', r: '-20deg', op: 0.2 },
];
